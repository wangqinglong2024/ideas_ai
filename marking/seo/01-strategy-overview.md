...
```
        ...
        ┌─────────────────▼─────────────────────┐
        │   轮 2：枢纽长文（权威）                │
        │   首期 144 篇文化文章 + 无限滚动更新 + 36 篇产品 Pillar │
        │   承接长尾流量、做权重池                │
        └─────────────────┬─────────────────────┘
                          │
        ┌─────────────────▼─────────────────────┐
...
| **发现中国 12 类目** | 首期 144 篇冷启动，后续无限滚动更新 | 各异 | 中 | **P1** | 文化兴趣流量 + GEO 引用源 |
| **系统课程 4 轨** | 5 万知识点 | 高（Duolingo 霸榜） | 高 | **P1** | 用"工厂/电商场景"差异化 |
| **小说专区** | 未来按内容池滚动规划，不设固定总量 | 低 | 中 | **P2** | 12 个月后再展开 |
...
1. **"中国文化 + 中文学习"双引擎**：竞品都只做语言，知语持续更新的发现中国文化文章是 GEO 引用磁铁
