...
> **课程内容不收文章 / 段落**。整段阅读由 [`/content/china/`](../china/00-index.md)「发现中国」与小说专区承载，与课程系统解耦。
...
知语 Zhiyu 平台共四大板块，本课程模块与其余三个板块的对称导航：

| 板块 | 入口 | 与课程的联动场景 |
|---|---|---|
| 🏛 发现中国 | [../china/00-index.md](../china/00-index.md) | 12 大文化类目；整段文化阅读，承接课程不收的"段落 / 长文"形态 |
| 🎮 游戏专区 | [../games/00-index.md](../games/00-index.md) | 12 款 2D 游戏，全部以课程题库为内容池；SRS 错题可一键开局复习 |
| 📖 小说专区 | [../novels/00-index.md](../novels/00-index.md) | 12 大热门类目原著 / 译著；章中长按生词加入课程「我的生词本」→ 进 SRS |

> 跨板块入口已在每个 `stage-*.md` 末尾以"今日推荐"形式自动展示。
