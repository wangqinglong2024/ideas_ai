...
## 摘要
PixiJS v8 + Matter + Howler 共享引擎包。**与 E10 一致采用 MVP 优先策略**：先交付足以驱动 G1-G5 五款 MVP 游戏的最小子集，再迭代到完整能力。
...
**AC**：push / pop / replace；MVP 仅含 Loading / Game / GameOver；V1 期补 Pause / Victory。
**估**：M
