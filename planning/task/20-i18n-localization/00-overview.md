...
- [ ] I18N-06 实现动态字体：th Sarabun、vi Be Vietnam Pro、en/id Plus Jakarta Sans、中文 Noto Sans SC，font-display swap。来源句：`I18N-FR-005` 与 `planning/prds/15-i18n/02-data-model-api.md` 字体加载示例。
...
- [ ] I18N-13 新文案必须 4 语齐备；本地检查缺 key 阻断。来源句：`I18N-FR-012` 写明“新文案需 4 语种齐备才能合并”。
- [ ] I18N-14 实现 `GET /api/i18n/locales/:lang/:ns`，客户端缺失时回退打包默认。来源句：`planning/prds/15-i18n/02-data-model-api.md` “API”。
