...
router.post('/lessons/:lessonId/quiz', async (req, res: Response) => {
...
router.post('/assessments/:attemptId/answers', async (req, res: Response) => {
  const { sub } = (req as unknown as AuthRequest).user
...
router.post('/assessments/:attemptId/submit', async (req, res: Response) => {
  const { sub } = (req as unknown as AuthRequest).user
  const { attemptId } = req.params
