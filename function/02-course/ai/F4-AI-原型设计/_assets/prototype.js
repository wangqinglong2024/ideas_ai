...
(function(){
  ...
  var TOAST_COPY = {
    ...
    '举报已提交，将由内容运营处理': ['Report submitted. Content operations will handle it.', 'Đã gửi báo cáo. Nhóm nội dung sẽ xử lý.', 'ส่งรายงานแล้ว ทีมเนื้อหาจะดำเนินการ', 'Laporan dikirim. Tim konten akan menangani.'],
...
(function(){
  ...
  var DICT = {
    zh: {
      ...
      'btn.adopt':'采纳','btn.dismiss':'忽略','btn.detail':'详情','btn.edit':'编辑',
