...
export const locales: Locale[] = ['en', 'vi', 'th', 'id', 'zh-CN'];
...
export const messages: Record<Locale, Record<string, string>> = {
  ...
  'zh-CN': { discover: '发现', courses: '课程', games: '游戏', profile: '我的', login: '登录', register: '注册', settings: '设置', dashboard: '仪表盘', audit: '审计', search: '搜索', language: '语言', pinyinMode: '拼音模式', translationMode: '翻译显示', fontSize: '字号', ttsSpeed: '朗读速度', unlockDiscover: '免费注册解锁全部发现中国内容' }
};
